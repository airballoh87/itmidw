IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_Study102Crf]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[usp_Study102Crf]
GO
/**************************************************************************
...
**************************************************************************/
CREATE PROCEDURE [dbo].[usp_Study102Crf]
AS
BEGIN
SET NOCOUNT ON;
